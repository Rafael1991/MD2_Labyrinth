	...
	void Update () {
        /*
         if (Input.GetKeyDown(KeyCode.Space))
         {
             ...
             inmt[] DepthImage = MeshScript.FilterdAndCroppedDepthImage;
             Bitap bitmap = new Bitmap(MeshScript.Width, MeshScript.Height, System.Drawing.Imaging.PixelFormat.Format32bppRgb);
         ...
         */
         ...
         System.Drawing.Point[] ToPointsArray(List<IntPoint> points)
        {
